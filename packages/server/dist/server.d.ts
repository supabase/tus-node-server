...
export declare class Server extends EventEmitter {
    ...
    write(req: http.IncomingMessage, res: http.ServerResponse, status: number, body: string | undefined, headers: {} | undefined, context: CancellationContext): http.ServerResponse<http.IncomingMessage>;
